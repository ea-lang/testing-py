...
def is_mel(name, email):
    """Is this user Mel?
        ...
        >>> is_mel('Tom Smith', 'tom@ubermelon.com')
        False
        >>> is_mel('Mel Melitpolski', 'mel@ubermelon.com')
        True
        >>> is_mel('Mel Melitpolski', 'info@uber.com')
        True
...
def most_and_least_common_type(treats):
    """Given list of treats, return {most, least} common types.
        ...
        >>> most_and_least_common_type([ {'type':'apple'},{'type':'berry'},{'type':'cherry'},{'type':'berry'},{'type':'cherry'}, {'type':'cherry'}])
        ('cherry', 'apple')
        >>> most_and_least_common_type([{'type':'cherry'},{'type':'cherry'}, {'type':'cherry'}])
        ('cherry', 'cherry')
        >>> most_and_least_common_type([])
        (None, None)
        >>> most_and_least_common_type([{'type':'berry'},{'type':'berry'},{'type':'cherry'}, {'type':'cherry'}])
        ('cherry', 'cherry')
        >>> treats = [{'type':'apple'},
        ... {'type':'berry'}]
